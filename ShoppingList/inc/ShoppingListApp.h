#ifndef _SHOPPING_LIST_APP_H_
#define _SHOPPING_LIST_APP_H_

#include "tizenx.h"


//  The ShoppingListApp class must inherit from the UiApp class,
...
public:
	...
	ShoppingListApp(void);
	virtual ~ShoppingListApp(void);
